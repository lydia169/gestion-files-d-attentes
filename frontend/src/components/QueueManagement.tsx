...
const QueueManagement: React.FC<QueueManagementProps> = ({ isAgentView = false }) => {
  ...
  // Generate HTML content for printing - with wait time, no "Centre de Santé"
...
<body>
  ...
  // Ticket Component - Display with wait time, no "Centre de Santé"
  const Ticket = () => {
    ...
    return (
      <div className="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50 flex items-center justify-center">
        <div className="bg-white p-8 rounded-lg shadow-xl max-w-md w-full mx-4">
          {/* Header - without "Centre de Santé" */}
