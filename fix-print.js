    ...
    return \`
      ...
      <head>
        ...
        <style>
          ...
          .priority {
            ...
            margin: 15px 0;
            font-weight: bold;
            \${ticketData.priorite === 'critique' ? 'background: #fee2e2; color: #991b1b;' : ticketData.priorite === 'urgent' ? 'background: #ffedd5; color: #9a3412;' : 'background: #dbeafe; color: #1e40af;'}
          }
          .footer {
            text-align: center;
      ...
      <body>
        ...
        <div class="ticket-number">
          <div class="number">#\${ticketData.numero}</div>
        ...
        <div class="info">
          <div class="info-row">
            ...
            <span class="value">\${ticketData.patient.nom} \${ticketData.patient.prenom}</span>
          </div>
          <div class="info-row">
            <span class="label">Service:</span>
            <span class="value">\${ticketData.service.nom}</span>
          </div>
          <div class="info-row">
            <span class="label">Date:</span>
            <span class="value">\${formatDate(ticketData.dateCreation)}</span>
          </div>
          <div class="info-row">
            <span class="label">Heure:</span>
            <span class="value">\${formatTime(ticketData.dateCreation)}</span>
          </div>
          <div class="info-row">
            <span class="label">Position:</span>
            <span class="value">\${ticketData.position} patient(s)</span>
          </div>
        </div>
        
        \${ticketData.priorite !== 'normal' ? \`<div class="priority">\${ticketData.priorite === 'critique' ? '⚠️ PRIORITÉ CRITIQUE' : '⚡ PRIORITÉ URGENTE'}</div>\` : ''}
  ...
  const Ticket = () => {
    ...
    return (
      <div className="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50 flex items-center justify-center">
        <div ref={ticketRef} className="bg-white p-8 rounded-lg shadow-xl max-w-md w-full mx-4">
          {/* Ticket Header */}
